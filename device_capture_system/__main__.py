...
def device_config_selection(device: PeripheryDevice, device_configurations: List[PeripheryDevice]) -> PeripheryDevice:
...
if __name__ == "__main__":
    ...
    if ARGS.configure:
        ...
        for device in devices:
            ...
            selected_device_configurations.append(device_config_selection(device, device_configurations))
